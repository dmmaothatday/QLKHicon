...
import QLKHController.PhieuNhapController;
 ...
 * @author VTTDung
 */
public class QLPhieuNhap_ChiTietForm extends javax.swing.JFrame {

    /**
     * Creates new form PhieuNhap_ChiTietForm
     */
    public static boolean check;
    final static String header[] = {"Mã sản phẩm","Số lượng"};
    final static DefaultTableModel tb = new DefaultTableModel(header, 0);
    public QLPhieuNhap_ChiTietForm(String MaPhieuNhap) {
        initComponents();
        PhieuNhapModel pn = PhieuNhapController.listChiTietPhieuNhap(MaPhieuNhap,"","");
        txtMaPhieuNhap.setText(MaPhieuNhap);
        txtMaPhieuNhap.setEnabled(false);
        if("Da nhap".equals(QLPhieuNhapForm.cboTrangThai.getSelectedItem().toString())){
            btnThem.setEnabled(false);
            btnXoa.setEnabled(false);
            btnSua.setEnabled(false);
        }
        loadTableChiTietPhieuNhap(pn.getDanhSachSP()); 
    }
    public static void loadTableChiTietPhieuNhap(ArrayList<SanPhamModel> ctpn){
        ...
        for(int i=0; i < ctpn.size(); i++){
            ...
            tb.addRow(pn);
            tbChiTietPhieuNhap.setModel(tb);
        }
    }
    ...
    private void initComponents() {
        ...
        lblChiTietPhieuNhap.setFont(new java.awt.Font("Segoe UI", 0, 36)); // NOI18N
        lblChiTietPhieuNhap.setText("CHI TIẾT PHIẾU NHẬP");
        jPanel1.add(lblChiTietPhieuNhap, new org.netbeans.lib.awtextra.AbsoluteConstraints(421, 39, -1, -1));
        ...
        jPanel1.add(txtMaPhieuNhap, new org.netbeans.lib.awtextra.AbsoluteConstraints(543, 105, 90, -1));

        txtMaSanPham.setLabelText("Mã sản phẩm");
        jPanel1.add(txtMaSanPham, new org.netbeans.lib.awtextra.AbsoluteConstraints(286, 191, 211, -1));

        spnSoLuong.setLabelText("Số lượng");
        jPanel1.add(spnSoLuong, new org.netbeans.lib.awtextra.AbsoluteConstraints(674, 190, 211, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 370, 1200, 230));
        ...
        jPanel1.add(btnDong, new org.netbeans.lib.awtextra.AbsoluteConstraints(1100, 60, 80, -1));
        ...
        jPanel1.add(btnThem, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 300, 80, -1));
        ...
        jPanel1.add(btnTim, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 300, 80, -1));
        ...
        jPanel1.add(btnSua, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 300, 80, -1));
        ...
        jPanel1.add(btnXoa, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 300, 80, -1));
        ...
        jPanel1.add(btnLamMoi, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 300, 80, -1));
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -100, 1200, 600));
    ...
    private void tbChiTietPhieuNhapMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbChiTietPhieuNhapMouseClicked
        // TODO add your handling code here:
        boolean checkClick = tbChiTietPhieuNhap.isEditing();
        if (checkClick == false){
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        // TODO add your handling code here:
        new PhieuNhapController(this).doAddChiTietPhieuNhap(txtMaPhieuNhap.getText());
    }//GEN-LAST:event_btnThemActionPerformed

    private void btnTimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimActionPerformed
        // TODO add your handling code here:
        new PhieuNhapController(this).doSearchChiTietPhieuNhap(txtMaPhieuNhap.getText());
    }//GEN-LAST:event_btnTimActionPerformed

    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        // TODO add your handling code here:
        new PhieuNhapController(this).doUpdateChiTietPhieuNhap(txtMaPhieuNhap.getText());
    }//GEN-LAST:event_btnSuaActionPerformed

    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        // TODO add your handling code here:
        new PhieuNhapController(this).doDeleteChiTietPhieuNhap(txtMaPhieuNhap.getText());
    ...
    private void btnLamMoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLamMoiActionPerformed
        ...
        check = false;
        tb.getDataVector().removeAllElements();
        loadTableChiTietPhieuNhap(PhieuNhapController.listChiTietPhieuNhap(txtMaPhieuNhap.getText(),"","").getDanhSachSP());
        txtMaSanPham.setText("");
        spnSoLuong.setValue(0);
    }//GEN-LAST:event_btnLamMoiActionPerformed
    public static SanPhamModel getChiTietPhieuNhapInput(){
     ...
     * @param MaPhieuNhap
     */
    public static void runViewDetailD(String MaPhieuNhap) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QLPhieuNhap_ChiTietForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new QLPhieuNhap_ChiTietForm(MaPhieuNhap).setVisible(true);
        });
    }
    ...
    private static QLKHView.swing.Spinner spnSoLuong;
    private static javax.swing.JTable tbChiTietPhieuNhap;
    private javax.swing.JTextField txtMaPhieuNhap;
    private static QLKHView.swing.TextField txtMaSanPham;
